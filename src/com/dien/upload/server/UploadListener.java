...
public class UploadListener extends AbstractUploadListener {
  ...
  /* (non-Javadoc)
   * @see com.dien.upload.server.AbstractUploadListener#remove()
   */
  public void remove() {
  ...
  /* (non-Javadoc)
   * @see com.dien.upload.server.AbstractUploadListener#save()
   */
  public void save() {
    if (session() != null) {
  ...
  /* (non-Javadoc)
   * @see com.dien.upload.server.AbstractUploadListener#update(long, long, int)
   */
  @Override
