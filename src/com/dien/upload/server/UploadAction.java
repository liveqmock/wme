...
public class UploadAction extends UploadServlet {
    ...
    if (parameter != null) {
      try {
        ...
        if (item != null) {
          ...
          renderJSONResponse(request, response, "{ret:false,msg:'"+ e.getMessage() + "'}");
        return;
      }
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try {
      ...
      renderXmlResponse(request, response, "{ret:true,msg:'取消成功'}");
      return;
    ...
    if (error != null) {
      renderXmlResponse(request, response, "{ret:false,msg:'" + error + "'}");
      if (listener != null) {
...
//      }
      ...
      obj.put("message", JSONObject.fromObject(message));
      renderXmlResponse(request, response, obj.toString(), true);
    }
