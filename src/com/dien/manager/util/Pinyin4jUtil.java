...
public class Pinyin4jUtil {  
    ...
    public static String getPinyinToUpperCase(String chinese) {  
        ...
        String str1 = getPinyinZh_CN(makeStringByStringSet(chinese)).toUpperCase();  
        return getPinyinZh_CN(deleteCn(str1)).toUpperCase();  
    }  
    ...
    public static Set<String> makeStringByStringSet(String chinese) {  
        ...
        if (chinese != null && !chinese.trim().equalsIgnoreCase("")) {  
            ...
            for (int i = 0; i < srcChar.length; i++) {  
                ...
                } else if ((int) c >= 95 || ((int) c >= 65 && (int) c <= 90)  
                        || ((int) c >= 97 && (int) c <= 122)|| ((int) c >= 48 && (int) c <= 59)) {  
            ...
            for (int i = 0; i < pingyinArray.length&&i<1; i++) {  
     ...
     * @throws BadHanyuPinyinOutputFormatCombination 
     */  
    public static Set<String> deleteCn(String chinese) {  
        if (chinese != null && !chinese.trim().equalsIgnoreCase("")) {  
            char[] srcChar = chinese.toCharArray();  
            String[][] temp = new String[chinese.length()][];  
            for (int i = 0; i < srcChar.length; i++) {  
                char c = srcChar[i];  
                if((int)c==58||(int)c==124){
                    temp[i] = new String[] { "" }; 
                    continue;
                }
    ...
    public static void main(String[] args) {
        ...
        String str = "";   
        System.out.println("小写输出：" + getPinyinToUpperCase(str));  
        ...
        //System.out.println("时间：" + Pinyin4jUtil.getPinyinJianPin("图标.PNG").split(",")[0]);  
