...
public class Commands {
    ...
    public static class CreateSeLayerCommand extends Command<SeLayer> {



        public CreateSeLayerCommand() {
    ...
    public static final class PrepareQueryCommand extends Command<SeQuery> {
        ...
        public PrepareQueryCommand(final SeQueryInfo qInfo ) {
            this.qInfo = qInfo;
        }
    ...
    * @author groldan
    */
   public static final class TableStatsCommand extends Command<SeTableStats> {
       ...
       public TableStatsCommand(final String tableName, final String columnName, final int mask ) {
           this.tableName = tableName;
       ...
       @Override
       public  SeTableStats execute(ISession session, SeConnection connection) throws SeException,
               IOException {
               ...
               SeTableStats  tableStats = query.calculateTableStatistics(columnName, mask, queryInfo, maxDistinct);
