...
class Session implements ISession {
     ...
     */
    public SeQuery prepareQuery(final SeQueryInfo qInfo) throws IOException {
        this.autoCloseCounter++;
        return issue(new Commands.PrepareQueryCommand(qInfo));
    }

    @Override
    public SeTableStats tableStats(String tableName, String columnName, int mask) throws IOException {
        // TODO Auto-generated method stub
        return issue(new Commands.TableStatsCommand(tableName, columnName, mask));
    }

    @Override
    public SeLayer createSeLayer() throws IOException {
        // TODO Auto-generated method stub
        return issue(new Commands.CreateSeLayerCommand());
    }
}
